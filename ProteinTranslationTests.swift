...
class ProteinTranslationTests: XCTestCase {
    ...
    func testTranslatesRNAStrandIntoCorrectProtein() {
        XCTAssertEqual(["Methionine", "Phenylalanine", "Tryptophan"], try! ProteinTranslation.translationOfRNA("AUGUUUUGG"))
    }
    ...
    func testStopsTranslationOfLongerStrand() {
        XCTAssertEqual(["Tryptophan", "Cysteine", "Tyrosine"], try! ProteinTranslation.translationOfRNA("UGGUGUUAUUAAUGGUUU"))
    }
